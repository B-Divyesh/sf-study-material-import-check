# Study Material Import Check (`study-material-import-check`) — factory product contract

This repository is one product built by the Param Factory. It ships at
`https://study-material-import-check.sociobot.in`. Artifact class: `static-web`.
